        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                { icon: <Mail />, label: 'Email', value: 'mulweyemorgan12@gmail.com' },
                { icon: <Phone />, label: 'Phone', value: '+254 790 424717' },
                ...
                >
                  <div className="p-3 bg-gradient-to-br from-blue-700 to-red-600 text-white rounded-lg">
                    {item.icon}
                  </div>
                  <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-blue-700 to-red-600 text-white rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
