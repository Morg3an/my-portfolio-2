          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-gradient-to-br from-blue-800 to-red-600 text-white rounded-lg">
                  {skill.icon}
                </div>
              ...
              <div className="relative h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-800 to-red-600 rounded-full transition-all duration-1000 ease-out"
                  style={{
                    width: '0%',
              ...
              <div className="mt-2 text-sm text-right text-gray-600 dark:text-gray-500">
                {skill.level}%
              </div>
            </div>
          ))}
